...
local a, display, eval, extract, jump, log, nrepl_action, nvim, own_state, server, state, str, text = autoload("conjure.aniseed.core"), autoload("conjure-clj-additions-vanilla.display-test-results"), autoload("conjure.eval"), autoload("conjure.extract"), autoload("conjure-clj-additions-vanilla.jump"), autoload("conjure.log"), autoload("conjure.client.clojure.nrepl.action"), autoload("conjure.aniseed.nvim"), autoload("conjure-clj-additions-vanilla.state"), autoload("conjure.client.clojure.nrepl.server"), autoload("conjure.client.clojure.nrepl.state"), autoload("conjure.aniseed.string"), autoload("conjure.text")
