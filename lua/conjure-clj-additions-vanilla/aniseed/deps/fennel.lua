package.preload["conjure-clj-additions-vanilla.aniseed.fennel.repl"] = package.preload["conjure-clj-additions-vanilla.aniseed.fennel.repl"] or function(...)
  local utils = require("conjure-clj-additions-vanilla.aniseed.fennel.utils")
  local parser = require("conjure-clj-additions-vanilla.aniseed.fennel.parser")
  local compiler = require("conjure-clj-additions-vanilla.aniseed.fennel.compiler")
  local specials = require("conjure-clj-additions-vanilla.aniseed.fennel.specials")
  local view = require("conjure-clj-additions-vanilla.aniseed.fennel.view")
...
package.preload["conjure-clj-additions-vanilla.aniseed.fennel.specials"] = package.preload["conjure-clj-additions-vanilla.aniseed.fennel.specials"] or function(...)
  local utils = require("conjure-clj-additions-vanilla.aniseed.fennel.utils")
  local view = require("conjure-clj-additions-vanilla.aniseed.fennel.view")
  local parser = require("conjure-clj-additions-vanilla.aniseed.fennel.parser")
  local compiler = require("conjure-clj-additions-vanilla.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "conjure-clj-additions-vanilla.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["conjure-clj-additions-vanilla.aniseed.fennel.compiler"] = package.preload["conjure-clj-additions-vanilla.aniseed.fennel.compiler"] or function(...)
  local utils = require("conjure-clj-additions-vanilla.aniseed.fennel.utils")
  local parser = require("conjure-clj-additions-vanilla.aniseed.fennel.parser")
  local friend = require("conjure-clj-additions-vanilla.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["conjure-clj-additions-vanilla.aniseed.fennel.friend"] = package.preload["conjure-clj-additions-vanilla.aniseed.fennel.friend"] or function(...)
  local utils = require("conjure-clj-additions-vanilla.aniseed.fennel.utils")
...
package.preload["conjure-clj-additions-vanilla.aniseed.fennel.parser"] = package.preload["conjure-clj-additions-vanilla.aniseed.fennel.parser"] or function(...)
  local utils = require("conjure-clj-additions-vanilla.aniseed.fennel.utils")
  local friend = require("conjure-clj-additions-vanilla.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["conjure-clj-additions-vanilla.aniseed.fennel.view"] = package.preload["conjure-clj-additions-vanilla.aniseed.fennel.view"] or function(...)
...
package.preload["conjure-clj-additions-vanilla.aniseed.fennel.utils"] = package.preload["conjure-clj-additions-vanilla.aniseed.fennel.utils"] or function(...)
  local view = require("conjure-clj-additions-vanilla.aniseed.fennel.view")
  local version = "1.1.0"
...
utils = require("conjure-clj-additions-vanilla.aniseed.fennel.utils")
local parser = require("conjure-clj-additions-vanilla.aniseed.fennel.parser")
local compiler = require("conjure-clj-additions-vanilla.aniseed.fennel.compiler")
local specials = require("conjure-clj-additions-vanilla.aniseed.fennel.specials")
local repl = require("conjure-clj-additions-vanilla.aniseed.fennel.repl")
local view = require("conjure-clj-additions-vanilla.aniseed.fennel.view")
...
do
  ...
  local module_name = "conjure-clj-additions-vanilla.aniseed.fennel.macros"
  local _
