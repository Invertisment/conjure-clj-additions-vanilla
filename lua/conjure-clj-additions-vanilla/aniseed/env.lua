...
local _2amodule_name_2a = "conjure-clj-additions-vanilla.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("conjure-clj-additions-vanilla.aniseed.compile"), autoload("conjure-clj-additions-vanilla.aniseed.fennel"), autoload("conjure-clj-additions-vanilla.aniseed.fs"), autoload("conjure-clj-additions-vanilla.aniseed.nvim")
