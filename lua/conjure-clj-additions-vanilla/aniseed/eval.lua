...
local _2amodule_name_2a = "conjure-clj-additions-vanilla.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("conjure-clj-additions-vanilla.aniseed.core"), autoload("conjure-clj-additions-vanilla.aniseed.compile"), autoload("conjure-clj-additions-vanilla.aniseed.fennel"), autoload("conjure-clj-additions-vanilla.aniseed.fs"), autoload("conjure-clj-additions-vanilla.aniseed.nvim")
