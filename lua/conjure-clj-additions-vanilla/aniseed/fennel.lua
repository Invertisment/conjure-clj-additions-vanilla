...
local _2amodule_name_2a = "conjure-clj-additions-vanilla.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("conjure-clj-additions-vanilla.aniseed.core"), autoload("conjure-clj-additions-vanilla.aniseed.fs"), autoload("conjure-clj-additions-vanilla.aniseed.nvim"), autoload("conjure-clj-additions-vanilla.aniseed.string")
...
local function impl()
  local compiler = require("conjure-clj-additions-vanilla.aniseed.deps.fennel")
