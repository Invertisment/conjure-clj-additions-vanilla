...
local _2amodule_name_2a = "conjure-clj-additions-vanilla.aniseed.fs"
local _2amodule_2a
do
...
local a, nvim = autoload("conjure-clj-additions-vanilla.aniseed.core"), autoload("conjure-clj-additions-vanilla.aniseed.nvim")
