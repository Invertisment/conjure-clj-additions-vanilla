...
local _2amodule_name_2a = "conjure-clj-additions-vanilla.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("conjure-clj-additions-vanilla.aniseed.core"), autoload("conjure-clj-additions-vanilla.aniseed.env"), autoload("conjure-clj-additions-vanilla.aniseed.eval"), autoload("conjure-clj-additions-vanilla.aniseed.nvim")
