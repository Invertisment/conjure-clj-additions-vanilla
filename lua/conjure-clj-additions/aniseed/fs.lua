...
local _2amodule_name_2a = "conjure-clj-additions.aniseed.fs"
local _2amodule_2a
do
...
local a, nvim = autoload("conjure-clj-additions.aniseed.core"), autoload("conjure-clj-additions.aniseed.nvim")
